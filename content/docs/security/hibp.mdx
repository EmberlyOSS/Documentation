...
When you log in, Emberly automatically checks whether your password appears in the **HaveIBeenPwned (HIBP)** database of over 10 billion compromised credentials.
