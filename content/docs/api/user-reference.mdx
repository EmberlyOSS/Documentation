...
Get a file's details and access history.

**Parameters:** None (file ID in URL)
...
List all your uploaded files with pagination.

**Query Parameters:**
- `page` (default: 1) — Page number
- `limit` (default: 50, max: 200) — Results per page
- `sort` — `recent`, `oldest`, `size`, `name`
...
- **Found a bug?** Create an issue on [GitHub](https://github.com/EmberlyOSS/Website)
