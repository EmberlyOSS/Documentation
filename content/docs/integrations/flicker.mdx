...
1. Go to [Emberly Dashboard](https://emberly.ca/dashboard) → **Settings → Profile**
...
2. Contact support@emberly.ca with the error message
...
- [Email Support](mailto:support@emberly.ca)
- [Official Website](https://emberly.ca)
