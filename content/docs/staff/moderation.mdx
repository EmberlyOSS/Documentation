...
The ban API takes an arbitrary `durationDays` value — these are suggested defaults per severity, not hard-coded tiers.

| Level | Suggested Duration | When to Use | Appeal |
|-------|----------|-----------|--------|
