...
| Flicker desktop app | Native desktop workflow |
...
Collaborators with the **Suggester** role can submit **edit suggestions** without directly modifying the file; **Editor**-role collaborators can edit directly. You review and accept or reject each suggestion — see [File Collaboration](/docs/user-guide/file-collaboration) for the full role breakdown.
