...
<Callout type="warn">
  **Cloud only.** This is a paid add-on billed through embrly.ca and isn't available on self-hosted instances (which already have full control over their own storage bucket) — see [Cloud vs. Self-Hosted](/docs/self-hosting/cloud-vs-self-hosted).
</Callout>
